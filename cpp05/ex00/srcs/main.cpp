...
/*   Updated: 2022/03/08 11:26:02 by mbonnet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
	...
	try
	{
		Bureaucrate Oroshimaru("Oroshimaru", 151);
	...
	try
	{
		Bureaucrate Konoamaru("Konoamaru", -1);
	...
	try
	{
		Bureaucrate Tsunade("Tsunade", 150);
